...
def score_game(player_data,dealer_data,table_index,cards_per_tc=20,debug=False):
    tot_score=0
    cidx=0
    while cidx+cards_per_tc<(player_data.shape[0]):
        player=Player.MyPlayer(table_index)
        curr_player_data=copy.deepcopy(player_data[cidx:cidx+cards_per_tc])
...
if __name__=='__main__':
    ...
    print("earnings")
    print(score_game(player_data,dealer_data,table_index,debug=False))